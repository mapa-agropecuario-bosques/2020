...
ARCHIVO_VECTORIAL_CULTIVOS <- 
  here(DIRECTORIO_CAPAS_ARCHIVOS_VECTORIALES, "cultivos-2017.gpkg")
...
ARCHIVO_VECTORIAL_BANANO <- 
  here(DIRECTORIO_CAPAS_ARCHIVOS_VECTORIALES, "fincas_Bananeras.shp")

# Archivo vectorial de caña 2020
ARCHIVO_VECTORIAL_CANA_2020 <- 
  here(DIRECTORIO_CAPAS_ARCHIVOS_VECTORIALES, "cultivo-cana-2020.gpkg")

# Archivo vectorial de cobertura forestal
ARCHIVO_VECTORIAL_COBERTURA_FORESTAL <- 
  here(DIRECTORIO_CAPAS_ARCHIVOS_VECTORIALES, "Cobertura forestal 2021.shp")


# Archivo raster de capa de uso agropecuario y bosques
ARCHIVO_RASTER_USO_AGROPECUARIO_BOSQUES <-
  here("data", "processed", "uso-agrpecuario-bosques-2020.tif")
